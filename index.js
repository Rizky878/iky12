...
if (text.includes(".haikyuu"))
   {
    var items = ["anime haikyuu", "anime haikyuu hd", "karakter anime haikyuu", "anime haikyuu aesthetic"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
...
if (text.includes(".aot"))
   {
    var items = ["anime attack on titan", "anime attack on titan hd", "anime attack on titan aesthetic", "karakter attack on titan"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
...
if (text.includes(".dxd"))
   {
    var items = ["anime high school dxd", "anime high school dxd hd", "karakter anime high school dxd", "anime high school dxd aesthetic"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
